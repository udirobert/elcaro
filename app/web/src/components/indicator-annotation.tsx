...
export function IndicatorAnnotation({
  ...
  return (
    ...
    >
      {/* A real button: keyboard focusable, screen-reader announced,
          with aria-expanded — the finding cards were click-only divs. */}
      <button
        onClick={onToggle}
        aria-expanded={expanded}
        className="w-full text-left cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-violet/40 rounded-lg"
      >
